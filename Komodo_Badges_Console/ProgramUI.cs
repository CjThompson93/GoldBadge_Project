...
namespace Komodo_Badges_Console
{
    class Program
    {
        ...
        {
            _repo.AddBadgeToDictionary(new Badge(12345, new List<string> { "A7" }));
            _repo.AddBadgeToDictionary(new Badge(22345, new List<string> { "A1", "A4", "B1", "B2" }));
            _repo.AddBadgeToDictionary(new Badge(32345, new List<string> { "A4", "A5",}));
        }
    }
}
